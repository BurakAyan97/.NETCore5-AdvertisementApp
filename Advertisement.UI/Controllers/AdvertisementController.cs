...
namespace Advertisement.UI.Controllers
{
    public class AdvertisementController : Controller
    {
        ...
        private readonly IAdvertisementAppUserService advertisementAppUserService;
        ...
        public AdvertisementController(IAppUserService appUserService, IAdvertisementAppUserService advertisementAppUserService)
        {
            ...
            this.advertisementAppUserService = advertisementAppUserService;
        }
        ...
        public async Task<IActionResult> Send(AdvertisementAppUserCreateModel model)
        {
            ...
            var response = await advertisementAppUserService.CreateAsync(dto);
            if (response.ResponseType is Common.ResponseType.ValidationError)
            {
        ...
        {
            var list = await advertisementAppUserService.GetList(AdvertisementAppUserStatusType.Basvurdu);
            return View(list);
        }
        ...
        {
            await advertisementAppUserService.SetStatusAsync(advertisementAppUserId, type);
        ...
        {
            var list = await advertisementAppUserService.GetList(AdvertisementAppUserStatusType.Mulakat);
            return View(list);
        }
        ...
        {
            var list = await advertisementAppUserService.GetList(AdvertisementAppUserStatusType.Olumsuz);
            return View(list);
        }
    }
}
